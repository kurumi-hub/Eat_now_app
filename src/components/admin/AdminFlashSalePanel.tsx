...
export default function AdminFlashSalePanel({ data }: { data: AdminFlashSaleData }) {
  ...
  const chooseCampaign = (id: string) => { setCampaignId(id); setDetailTab("items"); };
